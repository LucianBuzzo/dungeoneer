...
const Dungeon = function Dungeon () {
   ...
   */
  const _addRooms = () => {
    const maxRoomLength = stage.height * 0.3
    // const maxRoomSize = Infinity
    for (let i = 0; i < numRoomTries && _rooms.length < maxRoomLength; i++) {
...
const build = (options) => {
  console.log('building with KZ VERSION of Dungeoneer!!!')
